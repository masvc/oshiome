                        ...
                        <div className="space-y-6">
                            ...
                            <div>
                                <button
                                    type="button"
                                    onClick={signup}
                                    className="w-full flex justify-center py-2 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-oshi-purple hover:bg-oshi-indigo focus:outline-none focus:ring-1 focus:ring-offset-1 focus:ring-oshi-purple"
